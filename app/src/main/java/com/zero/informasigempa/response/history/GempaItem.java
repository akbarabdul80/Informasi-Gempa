...
public class GempaItem implements Serializable {
    ...
    public GempaItem(@Nullable String wilayah, @Nullable String kedalaman, @Nullable String jam, @Nullable String coordinates, @Nullable String potensi, @Nullable String tanggal, @Nullable String bujur, @Nullable String magnitude, @Nullable String lintang, @Nullable String dateTime, @Nullable String dirasakan) {
